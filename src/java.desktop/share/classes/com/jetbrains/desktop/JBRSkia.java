...
public abstract class JBRSkia {
    ...
    public static final long COMMAND_CAP64_HIGH_EFFECT_DESCRIPTOR_RUNTIME_COLOR_FILTER = Long.parseLong("16");
    ...
    /** Supports compact clear-rectangle plus full-source image reference draw records. */
    public static final long COMMAND_CAP64_HIGH_CLEAR_DRAW_IMAGE_REF_FULL = Long.parseLong("268435456");
    /** Supports compact full-source image reference draw plus round-rectangle draw records. */
    public static final long COMMAND_CAP64_HIGH_DRAW_IMAGE_REF_FULL_DRAW_ROUND_RECT = Long.parseLong("536870912");
    /** Supports compact runs of full-source image reference draw records. */
    public static final long COMMAND_CAP64_HIGH_DRAW_IMAGE_REF_FULL_RUN = Long.parseLong("1073741824");
    /** Supports compact saveLayer plus clipRect records. */
    public static final long COMMAND_CAP64_HIGH_SAVE_LAYER_CLIP_RECT = Long.parseLong("2147483648");
    /** Supports compact full-source image reference draw plus filled rectangle records. */
    public static final long COMMAND_CAP64_HIGH_DRAW_IMAGE_REF_FULL_FILL_RECT = Long.parseLong("4294967296");
    /** Supports compact stroke-line plus full-source image reference run records. */
    public static final long COMMAND_CAP64_HIGH_STROKE_LINE_DRAW_IMAGE_REF_FULL_RUN = Long.parseLong("8589934592");
    ...
    public static final long COMMAND_CAP64_HIGH_DRAW_ROUND_RECT_RESTORE_N = Long.parseLong("137438953472");
    public static final long COMMAND_CAP64_HIGH_STROKE_LINE_DRAW_IMAGE_REF_FULL_RUN_RESTORE_N = Long.parseLong("274877906944");
    public static final long COMMAND_CAP64_HIGH_DRAW_IMAGE_REF_FULL_RESTORE_N_SAVE_TRANSLATE_LAYER_SAVE_TRANSLATE =
    ...
    public static final long COMMAND_CAP64_HIGH_SAVE_SAVE_LAYER_SAVE_TRANSLATE = Long.parseLong("8796093022208");
    public static final long COMMAND_CAP64_HIGH_FILL_RECT_SAVE_LAYER_CLIP_RECT = Long.parseLong("17592186044416");
    public static final long COMMAND_CAP64_HIGH_SAVE_TRANSLATE_LAYER_SAVE_TRANSLATE_DRAW_IMAGE_REF_FULL_RESTORE_N =
            Long.parseLong("35184372088832");
    public static final long COMMAND_CAP64_HIGH_SAVE_TRANSLATE_LAYER_SAVE_TRANSLATE_DRAW_IMAGE_REF_FULL_RESTORE_N_SAVE_TRANSLATE_LAYER_SAVE_TRANSLATE =
            Long.parseLong("70368744177664");
    public static final long COMMAND_CAP64_HIGH_FILL_RECT_SAVE_LAYER_CLIP_RECT_SAVE_SAVE_LAYER_SAVE_TRANSLATE =
            Long.parseLong("140737488355328");
    public static final long COMMAND_CAP64_HIGH_SAVE_TRANSLATE_ROTATE = Long.parseLong("281474976710656");
    ...
    public static final long COMMAND_CAP64_HIGH_STROKE_OVAL_RUN = Long.parseLong("4503599627370496");
    public static final long COMMAND_CAP64_HIGH_SAVE_TRANSLATE_ROTATE_TRANSLATE_FILL_OVAL_RESTORE_RUN =
            Long.parseLong("18014398509481984");
    public static final long COMMAND_CAP64_HIGH_SAVE_TRANSLATE_ROTATE_TRANSLATE_STROKE_CLOSED_POLYLINE_DELTA_RESTORE =
            Long.parseLong("36028797018963968");
    public static final long COMMAND_CAP64_HIGH_FILL_RECT_RUN = Long.parseLong("72057594037927936");
    public static final long COMMAND_CAP64_HIGH_CLEAR_DRAW_IMAGE_REF_FULL_DRAW_ROUND_RECT =
            Long.parseLong("144115188075855872");
    public static final long COMMAND_CAP64_HIGH_STROKE_LINE_RUN = Long.parseLong("288230376151711744");
    public static final long COMMAND_CAP64_HIGH_SAVE_LAYER_CLIP_PATH = Long.parseLong("576460752303423488");
    ...
    public static final int COMMAND_CLEAR_DRAW_IMAGE_REF_FULL = Integer.parseInt("79");
    public static final int COMMAND_DRAW_IMAGE_REF_FULL_DRAW_ROUND_RECT = Integer.parseInt("80");
    public static final int COMMAND_DRAW_IMAGE_REF_FULL_RUN = Integer.parseInt("81");
    public static final int COMMAND_SAVE_LAYER_CLIP_RECT = Integer.parseInt("82");
    public static final int COMMAND_DRAW_IMAGE_REF_FULL_FILL_RECT = Integer.parseInt("83");
    ...
    public static final int COMMAND_DRAW_ROUND_RECT_RESTORE_N = Integer.parseInt("88");
    public static final int COMMAND_STROKE_LINE_DRAW_IMAGE_REF_FULL_RUN_RESTORE_N = Integer.parseInt("89");
    public static final int COMMAND_DRAW_IMAGE_REF_FULL_RESTORE_N_SAVE_TRANSLATE_LAYER_SAVE_TRANSLATE =
            Integer.parseInt("90");
    ...
    public static final int COMMAND_SAVE_SAVE_LAYER_SAVE_TRANSLATE = Integer.parseInt("94");
    public static final int COMMAND_FILL_RECT_SAVE_LAYER_CLIP_RECT = Integer.parseInt("95");
    public static final int COMMAND_SAVE_TRANSLATE_LAYER_SAVE_TRANSLATE_DRAW_IMAGE_REF_FULL_RESTORE_N =
            Integer.parseInt("96");
    public static final int COMMAND_SAVE_TRANSLATE_LAYER_SAVE_TRANSLATE_DRAW_IMAGE_REF_FULL_RESTORE_N_SAVE_TRANSLATE_LAYER_SAVE_TRANSLATE =
            Integer.parseInt("97");
    public static final int COMMAND_FILL_RECT_SAVE_LAYER_CLIP_RECT_SAVE_SAVE_LAYER_SAVE_TRANSLATE =
            Integer.parseInt("98");
    ...
    public static final int COMMAND_STROKE_OVAL_RUN = Integer.parseInt("103");
    public static final int COMMAND_SAVE_TRANSLATE_ROTATE_TRANSLATE_FILL_OVAL_RESTORE_RUN = Integer.parseInt("106");
    public static final int COMMAND_SAVE_TRANSLATE_ROTATE_TRANSLATE_STROKE_CLOSED_POLYLINE_DELTA_RESTORE =
            Integer.parseInt("107");
    public static final int COMMAND_FILL_RECT_RUN = Integer.parseInt("108");
    public static final int COMMAND_CLEAR_DRAW_IMAGE_REF_FULL_DRAW_ROUND_RECT = Integer.parseInt("109");
    public static final int COMMAND_STROKE_LINE_RUN = Integer.parseInt("110");
    public static final int COMMAND_SAVE_LAYER_CLIP_PATH = Integer.parseInt("111");
    ...
    public static final int COMMAND_EFFECT_DESCRIPTOR_STAMPED_PATH_EFFECT = Integer.parseInt("10");
    public static final int COMMAND_EFFECT_DESCRIPTOR_CHAIN_PATH_EFFECT = Integer.parseInt("11");
    ...
    public static final int COMMAND_SHADER_DESCRIPTOR_PERLIN_NOISE = Integer.parseInt("10");
