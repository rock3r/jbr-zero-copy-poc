...
- 2026-06-19 forced-context graphics-layer batch:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-command-probe-suite/20260619-195702/suite.tsv`
  passed `10/10` with `fallback_sum=0`, `unsupported_rows=0`, `jbr_picture_frames=0`, and
  `jbr_command_frames=115792`. Rows covered:
  `commands-forced-context-graphics-layer-chained-render-effect-blend-color-matrix-filter`,
  `commands-forced-context-graphics-layer-clip`, `commands-forced-context-graphics-layer-color-filter`,
  `commands-forced-context-graphics-layer-modulate-alpha`, `commands-forced-context-graphics-layer-near-camera`,
...
- 2026-06-19 forced-context graphics/image batch:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-command-probe-suite/20260619-203243/suite.tsv`
  passed `10/10` with `fallback_sum=0`, `unsupported_rows=0`, `jbr_picture_frames=0`, and
  `jbr_command_frames=105901`. Rows covered:
  ...
  `commands-forced-context-graphics-layer-shadow`, `commands-forced-context-image-blend-mode`,
  `commands-forced-context-image-color-matrix-filter`, `commands-forced-context-image-filter`,
  `commands-forced-context-image-shader`, `commands-forced-context-image-shader-blend-mode`, and
  `commands-forced-context-image-shader-color-filter`.
- 2026-06-19 forced-context lighting/gradient/runtime batch:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-command-probe-suite/20260619-205155/suite.tsv`
  passed `10/10` with `fallback_sum=0`, `unsupported_rows=0`, `jbr_picture_frames=0`, and
  `jbr_command_frames=97492`. Rows covered:
...
- 2026-06-19 resize graphics-transform/image batch:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-command-probe-suite/20260619-225139/suite.tsv`
  passed `10/10` with `fallback_sum=0`, `unsupported_rows=0`, `jbr_picture_frames=0`, and
  `jbr_command_frames=64964`. Rows covered:
  `commands-resize-graphics-layer-render-effect-color-matrix-filter`,
  `commands-resize-graphics-layer-rotationx`, `commands-resize-graphics-layer-rotationxy`,
  `commands-resize-graphics-layer-rotationy`, `commands-resize-graphics-layer-round-clip`,
  `commands-resize-graphics-layer-round-shadow`, `commands-resize-graphics-layer-scale-translate`,
  `commands-resize-graphics-layer-shadow`, `commands-resize-image-blend-mode`, and
  `commands-resize-image-color-matrix-filter`.
- 2026-06-19 resize image/effect batch:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-command-probe-suite/20260619-230949/suite.tsv`
  passed `10/10` with `fallback_sum=0`, `unsupported_rows=0`, `jbr_picture_frames=0`, and
  `jbr_command_frames=63510`. Rows covered:
  `commands-resize-image-filter`, `commands-resize-image-shader`,
  `commands-resize-image-shader-blend-mode`, `commands-resize-image-shader-color-filter`,
