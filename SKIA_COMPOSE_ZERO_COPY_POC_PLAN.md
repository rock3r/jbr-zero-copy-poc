...
- Direct RuntimeEffect shader parser coverage now includes SKSL/source-code validation and uniform/child/named-count
  bounds alongside the existing hash and schema checks.
