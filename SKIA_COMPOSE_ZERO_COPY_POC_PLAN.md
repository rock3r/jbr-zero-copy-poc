...
- Latest gradient validation adds live parser-guard rows for stroked gradient command widths. Skiko can corrupt the
  ...
  linear-gradient tile-mode slots to `4`, and radial-gradient radius slots to `0`, tile-mode slots to `4`,
  color-count slots to `1`, and second stop slots to `0` across fill/stroke
