...
After making the Magic Jewel button label explicit rather than relying on focused-theme content color, the focused
`parity-button-chrome` row passed again with `fallback_new_count=0`, `jbr_picture_frames=0`, `jbr_command_frames=753`,
...
The full default screenshot parity suite passed after adding `parity-clip-path`, covering 69 rows. The new clipPath row
passed with `fallback_new_count=0`, `jbr_picture_frames=0`, and `jbr_command_frames=979`; the same sweep also kept the
...
The full default screenshot parity suite then passed after adding `parity-clip-rects`, covering 70 rows. The clipRect
row passed with `fallback_new_count=0`, `jbr_picture_frames=0`, and `jbr_command_frames=994`; the same sweep kept the
button chrome, point dots, classpath resource-font, system-font, clipPath, and stroked-gradient rows on command replay:
`/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260506-185228/suite.tsv`.

Magic Jewel screenshot parity now includes a dedicated `parity-draw-shapes` row for the right-side drawPath,
drawArc, and drawRoundRect probes. Focused parity passed with `fallback_new_count=0`, `jbr_picture_frames=0`, and
...
The full default screenshot parity suite then passed after adding `parity-draw-shapes`, covering 71 rows. The new row
passed with `fallback_new_count=0`, `jbr_picture_frames=0`, and `jbr_command_frames=1379`; the same sweep kept button
chrome, classpath resource-font, system-font, clipRect/clip-out, and clipPath rows on command replay:
`/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260506-193855/suite.tsv`.

Magic Jewel screenshot parity now includes a dedicated `parity-blend-modes` row for the blend-mode grid signatures.
Focused parity passed with `fallback_new_count=0`, `jbr_picture_frames=0`, and `jbr_command_frames=931`:
`/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260506-202616/suite.tsv`.

The full default screenshot parity suite then passed after adding `parity-blend-modes`, covering 72 rows. The new row
passed with `fallback_new_count=0`, `jbr_picture_frames=0`, and `jbr_command_frames=869`; the same sweep kept button
...
Magic Jewel screenshot parity now also includes `parity-gradient-paths`, covering linear, radial, and sweep
gradient-filled paths. Focused parity passed with `fallback_new_count=0`, `jbr_picture_frames=0`, and
`jbr_command_frames=890`:
`/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260506-220635/suite.tsv`.

The full default screenshot parity suite then passed after adding `parity-gradient-paths`, covering 74 rows. The new row
passed with `fallback_new_count=0`, `jbr_picture_frames=0`, and `jbr_command_frames=1639`; the same sweep kept button
chrome, classpath resource-font, system-font, blend-mode, and gradient-surface rows on command replay:
`/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260506-220734/suite.tsv`.

Magic Jewel screenshot parity now also includes `parity-gradient-shaders`, covering explicit
`ShaderBrush(LinearGradientShader/RadialGradientShader/SweepGradientShader)` rects. Focused parity passed with
`fallback_new_count=0`, `jbr_picture_frames=0`, and `jbr_command_frames=901`:
`/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260507-093913/suite.tsv`.

The full default screenshot parity suite then passed after adding `parity-gradient-shaders`, covering 75 rows. The new
row passed with `fallback_new_count=0`, `jbr_picture_frames=0`, and `jbr_command_frames=593`; the same sweep kept
button chrome, classpath resource-font, system-font, gradient-surface, and gradient-path rows on command replay:
