...
public class JBRSkiaApiTest {
    ...
    private static long expectedCommandCapabilities64High() {
        return JBRSkia.COMMAND_CAP64_HIGH_SAVE_LAYER_IMAGE_FILTER_REF
                ...
                | JBRSkia.COMMAND_CAP64_HIGH_STROKE_PATH_LINEAR_GRADIENT
                | JBRSkia.COMMAND_CAP64_HIGH_STROKE_PATH_RADIAL_GRADIENT
                | JBRSkia.COMMAND_CAP64_HIGH_STROKE_PATH_SWEEP_GRADIENT
                | JBRSkia.COMMAND_CAP64_HIGH_STROKE_RECT_SHADER_REF
                | JBRSkia.COMMAND_CAP64_HIGH_STROKE_RECT_IMAGE_SHADER
                | JBRSkia.COMMAND_CAP64_HIGH_SAVE_TRANSLATE
    ...
    private static void assertCommandStreamValidation() {
        ...
        assertValidCommandStream(validFullImageRefStream(), "valid compact full image ref stream");
        ...
        assertValidCommandStream(validLinearGradientFillRectStream(), "valid linear-gradient fill rect stream");
        assertInvalidCommandStream(invalidLinearGradientFillRectTileModeStream(), "invalid linear-gradient fill rect tile mode");
        assertInvalidCommandStream(invalidLinearGradientFillRectColorCountStream(), "invalid linear-gradient fill rect color count");
        assertInvalidCommandStream(invalidLinearGradientFillRectStopOrderStream(), "invalid linear-gradient fill rect stop order");
        assertValidCommandStream(validLinearGradientFillRoundRectStream(), "valid linear-gradient fill round-rect stream");
        assertInvalidCommandStream(invalidLinearGradientFillRoundRectTileModeStream(), "invalid linear-gradient fill round-rect tile mode");
        assertInvalidCommandStream(invalidLinearGradientFillRoundRectColorCountStream(), "invalid linear-gradient fill round-rect color count");
        assertInvalidCommandStream(invalidLinearGradientFillRoundRectStopOrderStream(), "invalid linear-gradient fill round-rect stop order");
        assertValidCommandStream(validLinearGradientStrokeStream(), "valid linear-gradient stroke stream");
        assertInvalidCommandStream(invalidLinearGradientStrokeWidthStream(), "invalid linear-gradient stroke width");
        assertInvalidCommandStream(invalidLinearGradientStrokeTileModeStream(), "invalid linear-gradient stroke tile mode");
        assertInvalidCommandStream(invalidLinearGradientStrokeColorCountStream(), "invalid linear-gradient stroke color count");
        assertInvalidCommandStream(invalidLinearGradientStrokeStopOrderStream(), "invalid linear-gradient stroke stop order");
        ...
        assertInvalidCommandStream(invalidLinearGradientStrokeRoundRectWidthStream(), "invalid linear-gradient stroke round-rect width");
        assertInvalidCommandStream(invalidLinearGradientStrokeRoundRectTileModeStream(), "invalid linear-gradient stroke round-rect tile mode");
        assertInvalidCommandStream(invalidLinearGradientStrokeRoundRectColorCountStream(), "invalid linear-gradient stroke round-rect color count");
        assertInvalidCommandStream(invalidLinearGradientStrokeRoundRectStopOrderStream(), "invalid linear-gradient stroke round-rect stop order");
        assertValidCommandStream(validRadialGradientFillRectStream(), "valid radial-gradient fill rect stream");
        assertInvalidCommandStream(invalidRadialGradientFillRectRadiusStream(), "invalid radial-gradient fill rect radius");
        assertInvalidCommandStream(invalidRadialGradientFillRectTileModeStream(), "invalid radial-gradient fill rect tile mode");
        assertInvalidCommandStream(invalidRadialGradientFillRectColorCountStream(), "invalid radial-gradient fill rect color count");
        assertInvalidCommandStream(invalidRadialGradientFillRectStopOrderStream(), "invalid radial-gradient fill rect stop order");
        assertValidCommandStream(validRadialGradientFillRoundRectStream(), "valid radial-gradient fill round-rect stream");
        assertInvalidCommandStream(invalidRadialGradientFillRoundRectRadiusStream(), "invalid radial-gradient fill round-rect radius");
        assertInvalidCommandStream(invalidRadialGradientFillRoundRectTileModeStream(), "invalid radial-gradient fill round-rect tile mode");
        assertInvalidCommandStream(invalidRadialGradientFillRoundRectColorCountStream(), "invalid radial-gradient fill round-rect color count");
        assertInvalidCommandStream(invalidRadialGradientFillRoundRectStopOrderStream(), "invalid radial-gradient fill round-rect stop order");
        assertValidCommandStream(validRadialGradientStrokeStream(), "valid radial-gradient stroke stream");
        assertInvalidCommandStream(invalidRadialGradientStrokeWidthStream(), "invalid radial-gradient stroke width");
        assertInvalidCommandStream(invalidRadialGradientStrokeRadiusStream(), "invalid radial-gradient stroke radius");
        assertInvalidCommandStream(invalidRadialGradientStrokeTileModeStream(), "invalid radial-gradient stroke tile mode");
        assertInvalidCommandStream(invalidRadialGradientStrokeColorCountStream(), "invalid radial-gradient stroke color count");
        assertInvalidCommandStream(invalidRadialGradientStrokeStopOrderStream(), "invalid radial-gradient stroke stop order");
        assertValidCommandStream(validRadialGradientStrokeRoundRectStream(), "valid radial-gradient stroke round-rect stream");
        assertInvalidCommandStream(invalidRadialGradientStrokeRoundRectWidthStream(), "invalid radial-gradient stroke round-rect width");
        assertInvalidCommandStream(invalidRadialGradientStrokeRoundRectRadiusStream(), "invalid radial-gradient stroke round-rect radius");
    ...
    private static int[] validSaveTranslateRotateStream() {
        return new int[] {
                JBRSkia.COMMAND_STREAM_MAGIC, JBRSkia.ABI_ID, JBRSkia.COMMAND_STREAM_FLAGS_NONE, 9,
                JBRSkia.COMMAND_COORDINATE_SPACE_SWING_USER, JBRSkia.COMMAND_PAINT_FORMAT_SOLID_ARGB,
                JBRSkia.COMMAND_SAVE_TRANSLATE_ROTATE, 24, JBRSkia.COMMAND_RECORD_FLAGS_NONE, 1250, 2500, 18000,
                JBRSkia.COMMAND_RESTORE, 12, JBRSkia.COMMAND_RECORD_FLAGS_NONE
        };
    }

    private static int[] validSaveTranslateRotateTranslateFillOvalRestoreStream() {
        return new int[] {
                JBRSkia.COMMAND_STREAM_MAGIC, JBRSkia.ABI_ID, JBRSkia.COMMAND_STREAM_FLAGS_NONE, 13,
                JBRSkia.COMMAND_COORDINATE_SPACE_SWING_USER, JBRSkia.COMMAND_PAINT_FORMAT_SOLID_ARGB,
                JBRSkia.COMMAND_SAVE_TRANSLATE_ROTATE_TRANSLATE_FILL_OVAL_RESTORE,
                52, JBRSkia.COMMAND_RECORD_FLAG_ANTIALIAS,
                1250, 2500, 18000, 5000, 6000, 0xffff0000, 3, 4, 10, 20
        };
    }

    private static int[] validStrokeClosedPolylineStream() {
        return new int[] {
                JBRSkia.COMMAND_STREAM_MAGIC, JBRSkia.ABI_ID, JBRSkia.COMMAND_STREAM_FLAGS_NONE, 15,
                JBRSkia.COMMAND_COORDINATE_SPACE_SWING_USER, JBRSkia.COMMAND_PAINT_FORMAT_SOLID_ARGB,
                JBRSkia.COMMAND_STROKE_CLOSED_POLYLINE,
    ...
    private static int[] validFullImageRefStream() {
        return new int[] {
                JBRSkia.COMMAND_STREAM_MAGIC, JBRSkia.ABI_ID, JBRSkia.COMMAND_STREAM_FLAGS_NONE, 21,
                JBRSkia.COMMAND_COORDINATE_SPACE_SWING_USER, JBRSkia.COMMAND_PAINT_FORMAT_SOLID_ARGB,
                JBRSkia.COMMAND_DEFINE_IMAGE_ARGB, 48, JBRSkia.COMMAND_RECORD_FLAGS_NONE,
                0x12345678, 0x0abcdef0, 2, 2, 4,
                0xffff0000, 0xff00ff00, 0xff0000ff, 0xffffffff,
                JBRSkia.COMMAND_DRAW_IMAGE_REF_FULL, 36, JBRSkia.COMMAND_RECORD_FLAG_ANTIALIAS,
                10000, 20000, 30000, 40000, 0x12345678, 0x0abcdef0
        };
    }
    ...
    private static int[] validLinearGradientFillRectStream() {
        return new int[] {
                JBRSkia.COMMAND_STREAM_MAGIC, JBRSkia.ABI_ID, JBRSkia.COMMAND_STREAM_FLAGS_NONE, 17,
                JBRSkia.COMMAND_COORDINATE_SPACE_SWING_USER, JBRSkia.COMMAND_PAINT_FORMAT_SOLID_ARGB,
                JBRSkia.COMMAND_FILL_RECT_LINEAR_GRADIENT, 68, JBRSkia.COMMAND_RECORD_FLAG_ANTIALIAS,
                1, 2, 11, 12,
                1, 2, 11, 12, 1, 2, 0xff22d3ee, 0, 0xfff97316, 1000
        };
    }

    private static int[] invalidLinearGradientFillRectTileModeStream() {
        int[] commands = validLinearGradientFillRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 11] = 4;
        return commands;
    }

    private static int[] invalidLinearGradientFillRectColorCountStream() {
        int[] commands = validLinearGradientFillRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 12] = 1;
        return commands;
    }

    private static int[] invalidLinearGradientFillRectStopOrderStream() {
        int[] commands = validLinearGradientFillRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 14] = 750;
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 16] = 250;
        return commands;
    }

    private static int[] validLinearGradientFillRoundRectStream() {
        return new int[] {
                JBRSkia.COMMAND_STREAM_MAGIC, JBRSkia.ABI_ID, JBRSkia.COMMAND_STREAM_FLAGS_NONE, 19,
                JBRSkia.COMMAND_COORDINATE_SPACE_SWING_USER, JBRSkia.COMMAND_PAINT_FORMAT_SOLID_ARGB,
                JBRSkia.COMMAND_FILL_ROUND_RECT_LINEAR_GRADIENT, 76, JBRSkia.COMMAND_RECORD_FLAG_ANTIALIAS,
                1, 2, 11, 12, 3000, 4000,
                1, 2, 11, 12, 1, 2, 0xff22d3ee, 0, 0xfff97316, 1000
        };
    }

    private static int[] invalidLinearGradientFillRoundRectTileModeStream() {
        int[] commands = validLinearGradientFillRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 13] = 4;
        return commands;
    }

    private static int[] invalidLinearGradientFillRoundRectColorCountStream() {
        int[] commands = validLinearGradientFillRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 14] = 1;
        return commands;
    }

    private static int[] invalidLinearGradientFillRoundRectStopOrderStream() {
        int[] commands = validLinearGradientFillRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 16] = 750;
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 18] = 250;
        return commands;
    }
    ...
    private static int[] invalidLinearGradientStrokeWidthStream() {
        int[] commands = validLinearGradientStrokeStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 7] = 0;
        return commands;
    }

    private static int[] invalidLinearGradientStrokeTileModeStream() {
        int[] commands = validLinearGradientStrokeStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 15] = 4;
        return commands;
    }

    private static int[] invalidLinearGradientStrokeColorCountStream() {
        int[] commands = validLinearGradientStrokeStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 16] = 1;
        return commands;
    }

    private static int[] invalidLinearGradientStrokeStopOrderStream() {
        int[] commands = validLinearGradientStrokeStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 18] = 750;
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 20] = 250;
        return commands;
    }
    ...
    private static int[] invalidLinearGradientStrokeRoundRectWidthStream() {
        int[] commands = validLinearGradientStrokeRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 9] = 0;
        return commands;
    }

    private static int[] invalidLinearGradientStrokeRoundRectTileModeStream() {
        int[] commands = validLinearGradientStrokeRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 17] = 4;
        return commands;
    }

    private static int[] invalidLinearGradientStrokeRoundRectColorCountStream() {
        int[] commands = validLinearGradientStrokeRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 18] = 1;
        return commands;
    }

    private static int[] invalidLinearGradientStrokeRoundRectStopOrderStream() {
        int[] commands = validLinearGradientStrokeRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 20] = 750;
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 22] = 250;
        return commands;
    }

    private static int[] validRadialGradientFillRectStream() {
        return new int[] {
                JBRSkia.COMMAND_STREAM_MAGIC, JBRSkia.ABI_ID, JBRSkia.COMMAND_STREAM_FLAGS_NONE, 16,
                JBRSkia.COMMAND_COORDINATE_SPACE_SWING_USER, JBRSkia.COMMAND_PAINT_FORMAT_SOLID_ARGB,
                JBRSkia.COMMAND_FILL_RECT_RADIAL_GRADIENT, 64, JBRSkia.COMMAND_RECORD_FLAG_ANTIALIAS,
                1, 2, 11, 12, 6, 7, 8000, 1, 2, 0xff22d3ee, 0, 0xfff97316, 1000
        };
    }

    private static int[] invalidRadialGradientFillRectRadiusStream() {
        int[] commands = validRadialGradientFillRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 9] = 0;
        return commands;
    }

    private static int[] invalidRadialGradientFillRectTileModeStream() {
        int[] commands = validRadialGradientFillRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 10] = 4;
        return commands;
    }

    private static int[] invalidRadialGradientFillRectColorCountStream() {
        int[] commands = validRadialGradientFillRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 11] = 1;
        return commands;
    }

    private static int[] invalidRadialGradientFillRectStopOrderStream() {
        int[] commands = validRadialGradientFillRectStream();
    ...
    private static int[] validRadialGradientFillRoundRectStream() {
        return new int[] {
                JBRSkia.COMMAND_STREAM_MAGIC, JBRSkia.ABI_ID, JBRSkia.COMMAND_STREAM_FLAGS_NONE, 18,
                JBRSkia.COMMAND_COORDINATE_SPACE_SWING_USER, JBRSkia.COMMAND_PAINT_FORMAT_SOLID_ARGB,
                JBRSkia.COMMAND_FILL_ROUND_RECT_RADIAL_GRADIENT, 72, JBRSkia.COMMAND_RECORD_FLAG_ANTIALIAS,
                1, 2, 11, 12, 3000, 4000, 6, 7, 8000, 1, 2, 0xff22d3ee, 0, 0xfff97316, 1000
        };
    }

    private static int[] invalidRadialGradientFillRoundRectRadiusStream() {
        int[] commands = validRadialGradientFillRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 11] = 0;
        return commands;
    }

    private static int[] invalidRadialGradientFillRoundRectTileModeStream() {
        int[] commands = validRadialGradientFillRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 12] = 4;
        return commands;
    }

    private static int[] invalidRadialGradientFillRoundRectColorCountStream() {
        int[] commands = validRadialGradientFillRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 13] = 1;
        return commands;
    }

    private static int[] invalidRadialGradientFillRoundRectStopOrderStream() {
        int[] commands = validRadialGradientFillRoundRectStream();
    ...
    private static int[] invalidRadialGradientStrokeWidthStream() {
        int[] commands = validRadialGradientStrokeStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 7] = 0;
        return commands;
    }

    private static int[] invalidRadialGradientStrokeRadiusStream() {
        int[] commands = validRadialGradientStrokeStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 13] = 0;
        return commands;
    }

    private static int[] invalidRadialGradientStrokeTileModeStream() {
        int[] commands = validRadialGradientStrokeStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 14] = 4;
        return commands;
    }

    private static int[] invalidRadialGradientStrokeColorCountStream() {
        int[] commands = validRadialGradientStrokeStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 15] = 1;
        return commands;
    }

    private static int[] invalidRadialGradientStrokeStopOrderStream() {
        int[] commands = validRadialGradientStrokeStream();
    ...
    private static int[] invalidRadialGradientStrokeRoundRectWidthStream() {
        int[] commands = validRadialGradientStrokeRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 9] = 0;
        return commands;
    }

    private static int[] invalidRadialGradientStrokeRoundRectRadiusStream() {
        int[] commands = validRadialGradientStrokeRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 15] = 0;
        return commands;
    }

    private static int[] invalidRadialGradientStrokeRoundRectTileModeStream() {
        int[] commands = validRadialGradientStrokeRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 16] = 4;
        return commands;
    }

    private static int[] invalidRadialGradientStrokeRoundRectColorCountStream() {
        int[] commands = validRadialGradientStrokeRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 17] = 1;
        return commands;
    }

    private static int[] invalidRadialGradientStrokeRoundRectStopOrderStream() {
        int[] commands = validRadialGradientStrokeRoundRectStream();
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 19] = 750;
        commands[JBRSkia.COMMAND_STREAM_HEADER_SIZE + 21] = 250;
        return commands;
    }
