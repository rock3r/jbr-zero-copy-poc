...
- Magic Jewel full default command-probe sweep passed in command-marker-only mode after the latest focused quick-group
  refreshes and parser/fallback sentinel checks: 487/487 passed, `fallback_sum=350`, `unsupported_rows=26`,
  `jbr_picture_frames=33632`, `jbr_command_frames=183989`, suite
...
- Magic Jewel focused command-probe `CASE_GROUPS=save-layer-invalid` passed as the current saveLayer parser guard
  checkpoint: 37/37 passed, `fallback_sum=37`, `unsupported_rows=1`, `jbr_picture_frames=0`,
  `jbr_command_frames=0`, suite
...
- Magic Jewel focused command-probe `CASE_GROUPS=runtime-effect-invalid` passed as the current RuntimeEffect
  ...
  `jbr_picture_frames=5670`, `jbr_command_frames=0`, suite
