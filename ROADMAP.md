...
- Raw Skiko-owned pointers must not cross the ABI. Known shader/effect/font/image families use serialized descriptors
  or JBR-owned handles; unknown/raw families must be promoted to descriptor/handle-backed commands or kept as explicit
  command-stream invalid sentinels until the zero-unsupported goal is complete.
...
- Focused ABI 111 command-stream compaction checkpoint:
  ...
  `unsupported_max=0`, `jbr_picture_frames=0`, `jbr_command_frames=1012`, raw logs showing `strokeOvalRun=1` per
  frame, and logged average command stream size dropped from `1956` words/frame in the retained-op102 run to `1933`
  words/frame:
...
- Focused ABI 111 command-stream compaction checkpoint:
  Added `COMMAND_STROKE_CLOSED_POLYLINE_DELTA` (`op=102`) plus matching high capability bit `2251799813685248` for
  compact closed-polyline stroke records with signed-short packed fixed1000 deltas. Narrow gates passed: CMP focused
  recorder test, Skiko interop test, local CMP/Skiko publishes, `./scripts/rebuild-jbr-skia-local-artifacts.sh`, and
  focused Hypnotoad validation. The focused Hypnotoad slice stayed strict-clean with `fallbacks=0`,
  `unsupported_max=0`, `jbr_picture_frames=0`, `jbr_command_frames=896`,
  `strokeClosedPolylineDelta:total=4475`, and logged average command stream size dropped from `2854.9` words/frame in
  the retained-op101 run to `1957.7` words/frame:
...
- Focused CMP-only command-stream compaction checkpoint:
  ...
  tests, desktop-only CMP publish, and focused Markdown wheel validation. The focused Markdown slice stayed
  strict-clean with `fallbacks=0`, `unsupported_max=0`, `jbr_picture_frames=0`, `jbr_command_frames=252`, and
  `avg_commands=376`, down from the previous CMP-only checkpoint's `379`:
...
- Focused ABI 111 command-stream compaction checkpoint:
  ...
  `fillRect; saveLayer; clipRect` records. Narrow gates passed: CMP focused recorder tests, Skiko focused interop
  test, `./scripts/rebuild-jbr-skia-local-artifacts.sh`, and focused Markdown wheel validation. The focused Markdown
  slice stayed strict-clean with `fallbacks=0`, `unsupported_max=0`, `jbr_picture_frames=0`,
  `jbr_command_frames=264`, and `fillRectSaveLayerClipRect:total=455`:
...
- Magic Jewel tightened the standalone graphics-layer offcenter-pivot zero-handle lifecycle screenshot-parity row with
  ...
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-offcenter-pivot" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 666 JBR command frames, `avg_delta=2.191`, `bad_pixel_ratio=0.05201`, output directory
  2.7M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-135751/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer near-camera zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-near-camera" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 995 JBR command frames, `avg_delta=2.191`, `bad_pixel_ratio=0.05200`, output directory
  4.0M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-135418/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer scale-translate zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-scale-translate" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 679 JBR command frames, `avg_delta=2.190`, `bad_pixel_ratio=0.05192`, output directory
  3.7M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-135101/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer rotation-xy zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-rotationxy" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 561 JBR command frames, `avg_delta=2.191`, `bad_pixel_ratio=0.05200`, output directory
  2.6M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-134724/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer rotation-y zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-rotationy" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 633 JBR command frames, `avg_delta=2.189`, `bad_pixel_ratio=0.05189`, output directory
  2.6M, and about 197Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-134419/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer rotation-x zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-rotationx" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 537 JBR command frames, `avg_delta=2.191`, `bad_pixel_ratio=0.05199`, output directory
  3.6M, and about 197Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-133945/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer modulate-alpha zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-modulate-alpha" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 1,229 JBR command frames, `avg_delta=2.620`, `bad_pixel_ratio=0.06560`, output
  directory 4.2M, and about 196Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-133608/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer offscreen zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-offscreen" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 670 JBR command frames, `avg_delta=2.191`, `bad_pixel_ratio=0.05195`, output directory
  3.7M, and about 196Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-133233/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer path-shadow zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-path-shadow" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 1,154 JBR command frames, `avg_delta=2.194`, `bad_pixel_ratio=0.05213`, output
  directory 4.2M, and about 196Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-132849/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer round-shadow zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-round-shadow" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 618 JBR command frames, `avg_delta=2.206`, `bad_pixel_ratio=0.05203`, output directory
  3.8M, and about 196Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-132523/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer shadow zero-handle lifecycle screenshot-parity row with explicit
  ...
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 1,121 JBR command frames, `avg_delta=2.187`, `bad_pixel_ratio=0.05189`, output
  directory 4.2M, and about 196Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-132154/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer path-clip zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-path-clip" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 930 JBR command frames, `avg_delta=2.194`, `bad_pixel_ratio=0.05213`, output directory
  3.9M, and about 196Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-131846/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer round-clip zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-round-clip" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 632 JBR command frames, `avg_delta=2.194`, `bad_pixel_ratio=0.05204`, output directory
  3.6M, and about 196Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-131538/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer clip zero-handle lifecycle screenshot-parity row with explicit
  zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle siblings,
  then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-clip" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 601 JBR command frames, `avg_delta=2.190`, `bad_pixel_ratio=0.05189`, output directory
  2.6M, and about 196Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-131231/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer blend+color-filter zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-blend-color-filter" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 915 JBR command frames, `avg_delta=2.197`, `bad_pixel_ratio=0.05280`, output directory
  4.0M, and about 197Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-130849/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer color-filter zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-color-filter" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 1,023 JBR command frames, `avg_delta=2.188`, `bad_pixel_ratio=0.05189`, output
  directory 4.1M, and about 197Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-130537/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer blend-mode zero-handle lifecycle screenshot-parity row with
  explicit zero ceilings for JBR effect-handle and shader-handle defines, matching its resize/forced-context lifecycle
  siblings, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-blend-mode" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero effect-handle markers, zero shader-handle markers,
  and screenshot status passed: 774 JBR command frames, `avg_delta=2.206`, `bad_pixel_ratio=0.05278`, output directory
  3.8M, and about 197Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-130233/suite.tsv`.
...
- Magic Jewel tightened the standalone graphics-layer effects lifecycle screenshot-parity row with an explicit zero
  ...
  markers, and screenshot status passed: 925 JBR command frames, eight effect-handle define frames, 1,578 effect-handle
  use frames, 1,574 effect-handle cache-hit frames, `avg_delta=2.182`, `bad_pixel_ratio=0.05159`, output directory
  4.2M, and about 197Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-125619/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer near-camera chained-render-effect+blend+color-matrix-filter
  lifecycle screenshot-parity row with an explicit zero ceiling for JBR shader-handle defines while preserving the
  existing nonzero effect-handle lifecycle gates, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-near-camera-chained-render-effect-blend-color-matrix-filter" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero shader-handle markers, active bounded effect-handle
  markers, and screenshot status passed: 893 JBR command frames, 12 effect-handle define frames, 3,334 effect-handle
  use frames, 3,326 effect-handle cache-hit frames, `avg_delta=2.596`, `bad_pixel_ratio=0.06468`, output directory
  5.3M, and about 197Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-125326/suite.tsv`.
...
- Magic Jewel tightened the standalone graphics-layer offset-effect+blend+color-matrix-filter lifecycle screenshot-parity
  ...
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-offset-effect-blend-color-matrix-filter" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero shader-handle markers, active bounded effect-handle
  markers, and screenshot status passed: 662 JBR command frames, eight effect-handle define frames, 2,884 effect-handle
  use frames, 2,876 effect-handle cache-hit frames, `avg_delta=2.606`, `bad_pixel_ratio=0.06559`, output directory
  4.0M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-124516/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer render-effect+blend+color-matrix-filter lifecycle screenshot-parity
  row with an explicit zero ceiling for JBR shader-handle defines while preserving the existing nonzero effect-handle
  lifecycle gates, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-render-effect-blend-color-matrix-filter" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero shader-handle markers, active bounded effect-handle
  markers, and screenshot status passed: 670 JBR command frames, eight effect-handle define frames, 2,888 effect-handle
  use frames, 2,880 effect-handle cache-hit frames, `avg_delta=2.715`, `bad_pixel_ratio=0.06922`, output directory
  4.0M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-124152/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer render-effect+blend+color-filter lifecycle screenshot-parity row
  with an explicit zero ceiling for JBR shader-handle defines while preserving the existing nonzero effect-handle
  lifecycle gates, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-render-effect-blend-color-filter" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero shader-handle markers, active bounded effect-handle
  markers, and screenshot status passed: 811 JBR command frames, four effect-handle define frames, 1,738 effect-handle
  use frames, 1,734 effect-handle cache-hit frames, `avg_delta=2.747`, `bad_pixel_ratio=0.06926`, output directory
  4.0M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-123838/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer chained-render-effect lifecycle screenshot-parity row with an
  explicit zero ceiling for JBR shader-handle defines while preserving the existing nonzero effect-handle lifecycle
  gates, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-chained-render-effect" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero shader-handle markers, active bounded effect-handle
  markers, and screenshot status passed: 1,081 JBR command frames, eight effect-handle define frames, 1,638
  effect-handle use frames, 1,634 effect-handle cache-hit frames, `avg_delta=2.182`, `bad_pixel_ratio=0.05159`, output
  directory 4.2M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-123457/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer offset-effect lifecycle screenshot-parity row with an explicit zero
  ceiling for JBR shader-handle defines while preserving the existing nonzero effect-handle lifecycle gates, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-offset-effect" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero shader-handle markers, active bounded effect-handle
  markers, and screenshot status passed: 810 JBR command frames, five effect-handle define frames, 1,627 effect-handle
  use frames, 1,622 effect-handle cache-hit frames, `avg_delta=2.189`, `bad_pixel_ratio=0.05189`, output directory
  4.0M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-123100/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer render-effect+color-matrix-filter lifecycle screenshot-parity row
  with an explicit zero ceiling for JBR shader-handle defines while preserving the existing nonzero effect-handle
  lifecycle gates, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-render-effect-color-matrix-filter" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero shader-handle markers, active bounded effect-handle
  markers, and screenshot status passed: 718 JBR command frames, eight effect-handle define frames, 3,144 effect-handle
  use frames, 3,136 effect-handle cache-hit frames, `avg_delta=2.186`, `bad_pixel_ratio=0.05176`, output directory
  4.0M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-122802/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer render-effect+blend-mode lifecycle screenshot-parity row with an
  explicit zero ceiling for JBR shader-handle defines while preserving the existing nonzero effect-handle lifecycle
  gates, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-render-effect-blend-mode" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero shader-handle markers, active bounded effect-handle
  markers, and screenshot status passed: 1,245 JBR command frames, five effect-handle define frames, 2,123
  effect-handle use frames, 2,118 effect-handle cache-hit frames, `avg_delta=2.749`, `bad_pixel_ratio=0.06922`, output
  directory 5.5M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-122503/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer render-effect+color-filter lifecycle screenshot-parity row with an
  explicit zero ceiling for JBR shader-handle defines while preserving the existing nonzero effect-handle lifecycle
  gates, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-render-effect-color-filter" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero shader-handle markers, active bounded effect-handle
  markers, and screenshot status passed: 1,247 JBR command frames, four effect-handle define frames, 2,266
  effect-handle use frames, 2,262 effect-handle cache-hit frames, `avg_delta=2.185`, `bad_pixel_ratio=0.05176`, output
  directory 5.5M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-122208/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer blend+color-matrix-filter lifecycle screenshot-parity row with an
  explicit zero ceiling for JBR shader-handle defines while preserving the existing nonzero effect-handle lifecycle
  gates, then reran
  `DURATION_SECONDS=5 WARMUP_SECONDS=1 CASES="parity-graphics-layer-blend-color-matrix-filter" ./scripts/jbr-skia-screenshot-parity-suite.sh`.
  The exact row passed fallback-free with zero picture frames, zero shader-handle markers, active bounded effect-handle
  markers, and screenshot status passed: 676 JBR command frames, four effect-handle define frames, 1,519
  effect-handle use frames, 1,515 effect-handle cache-hit frames, `avg_delta=2.206`, `bad_pixel_ratio=0.05278`, output
  directory 3.9M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-121906/suite.tsv`.
- Magic Jewel tightened the standalone graphics-layer color-matrix-filter lifecycle screenshot-parity row with an
  ...
  The exact row passed fallback-free with zero picture frames, zero shader-handle markers, active bounded effect-handle
  markers, and screenshot status passed: 1,107 JBR command frames, four effect-handle define frames, 1,964
  effect-handle use frames, 1,960 effect-handle cache-hit frames, `avg_delta=2.189`, `bad_pixel_ratio=0.05189`, output
  directory 5.4M, and about 170Gi free. This was an exact one-row screenshot-parity refresh, not the full suite:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-121632/suite.tsv`.
...
- Magic Jewel tightened the exact graphics-layer chained-render-effect+blend-color-matrix-filter lifecycle
  ...
  Both exact rows passed with zero picture frames, zero shader-handle markers, active bounded effect-handle markers,
  and screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 671 JBR command frames, 21 effect-handle define frames, 3,054 effect-handle use frames,
  3,040 effect-handle cache-hit frames, `avg_delta=2.348`, `bad_pixel_ratio=0.06017`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 744 JBR command frames, 30 effect-handle define frames,
  2,628 effect-handle use frames, 2,608 effect-handle cache-hit frames, `avg_delta=2.575`,
  `bad_pixel_ratio=0.06531`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 8.0M and disk free was about 170Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-120245/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer offset-effect+blend-color-matrix-filter lifecycle screenshot-parity pair
  with explicit zero ceilings for JBR shader-handle defines while preserving the existing nonzero effect-handle
  lifecycle gates, then reran
  ...
  Both exact rows passed with zero picture frames, zero shader-handle markers, active bounded effect-handle markers,
  and screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 825 JBR command frames, 16 effect-handle define frames, 3,428 effect-handle use frames,
  3,412 effect-handle cache-hit frames, `avg_delta=2.257`, `bad_pixel_ratio=0.05727`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 612 JBR command frames, 20 effect-handle define frames,
  2,572 effect-handle use frames, 2,552 effect-handle cache-hit frames, `avg_delta=2.465`,
  `bad_pixel_ratio=0.06185`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 8.8M and disk free was about 170Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-115840/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer render-effect+blend-color-matrix-filter lifecycle screenshot-parity pair
  with explicit zero ceilings for JBR shader-handle defines while preserving the existing nonzero effect-handle
  lifecycle gates, then reran
  ...
  Both exact rows passed with zero picture frames, zero shader-handle markers, active bounded effect-handle markers,
  and screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 782 JBR command frames, 16 effect-handle define frames, 2,724 effect-handle use frames,
  2,708 effect-handle cache-hit frames, `avg_delta=2.348`, `bad_pixel_ratio=0.06017`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 888 JBR command frames, 22 effect-handle define frames,
  3,002 effect-handle use frames, 2,980 effect-handle cache-hit frames, `avg_delta=2.574`,
  `bad_pixel_ratio=0.06548`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 8.2M and disk free was about 170Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-115429/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer render-effect+blend-color-filter lifecycle screenshot-parity pair with
  ...
  Both exact rows passed with zero picture frames, zero shader-handle markers, active bounded effect-handle markers,
  and screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 717 JBR command frames, eight effect-handle define frames, 1,696 effect-handle use frames,
  1,688 effect-handle cache-hit frames, `avg_delta=2.373`, `bad_pixel_ratio=0.06020`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 1,123 JBR command frames, 11 effect-handle define
  frames, 1,708 effect-handle use frames, 1,697 effect-handle cache-hit frames, `avg_delta=2.606`,
  `bad_pixel_ratio=0.06552`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 8.0M and disk free was about 170Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-115032/suite.tsv`.
...
- Magic Jewel tightened the exact graphics-layer offset-effect lifecycle screenshot-parity pair with explicit zero
  ...
  Both exact rows passed with zero picture frames, zero shader-handle markers, active bounded effect-handle markers,
  and screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 607 JBR command frames, eight effect-handle define frames, 1,218 effect-handle use frames,
  1,210 effect-handle cache-hit frames, `avg_delta=1.908`, `bad_pixel_ratio=0.04583`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 840 JBR command frames, 11 effect-handle define frames,
  1,522 effect-handle use frames, 1,511 effect-handle cache-hit frames, `avg_delta=2.048`,
  `bad_pixel_ratio=0.04815`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 7.6M and disk free was about 197Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-114236/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer render-effect lifecycle screenshot-parity pair with explicit zero
  ceilings for JBR shader-handle defines while preserving the existing nonzero effect-handle lifecycle gates, then reran
  ...
  Both exact rows passed with zero picture frames, zero shader-handle markers, active bounded effect-handle markers,
  and screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 1,299 JBR command frames, eight effect-handle define frames, 2,168 effect-handle use
  frames, 2,160 effect-handle cache-hit frames, `avg_delta=1.902`, `bad_pixel_ratio=0.04557`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 1,251 JBR command frames, eight effect-handle define
  frames, 1,667 effect-handle use frames, 1,659 effect-handle cache-hit frames, `avg_delta=2.045`,
  `bad_pixel_ratio=0.04801`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 9.8M and disk free was about 197Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-113829/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer color-matrix-filter lifecycle screenshot-parity pair with explicit zero
  ceilings for JBR shader-handle defines while preserving the existing nonzero effect-handle lifecycle gates, then reran
  ...
  `bad_pixel_ratio=0.04815`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 7.8M and disk free was about 197Gi:
...
- Magic Jewel tightened the exact graphics-layer render-effect+blend-mode lifecycle screenshot-parity pair with
  ...
  `bad_pixel_ratio=0.06548`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 9.5M and disk free was about 197Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-112252/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer render-effect+color-filter lifecycle screenshot-parity pair with
  explicit zero ceilings for JBR shader-handle defines and refreshed the resize effect-handle define ceiling from 7 to
  8 to match current report evidence, then reran
  ...
  Both exact rows passed with zero picture frames, zero shader-handle markers, active bounded effect-handle markers,
  and screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 1,143 JBR command frames, eight effect-handle define frames, 1,925 effect-handle use
  frames, 1,917 effect-handle cache-hit frames, `avg_delta=1.901`, `bad_pixel_ratio=0.04557`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 1,071 JBR command frames, 11 effect-handle define
  frames, 1,851 effect-handle use frames, 1,840 effect-handle cache-hit frames, `avg_delta=2.044`,
  `bad_pixel_ratio=0.04801`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 8.3M and disk free was about 197Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-111854/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer blend-color-matrix-filter lifecycle screenshot-parity pair with
  explicit zero ceilings for JBR shader-handle defines while preserving the existing nonzero effect-handle lifecycle
  gates, then reran
  ...
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 9.3M and disk free was about 197Gi:
...
- Magic Jewel restored the live exact graphics-layer offscreen lifecycle zero ceilings for JBR effect-handle and
  ...
  artifact, then passed with 1,190 JBR command frames, `avg_delta=1.909`, `bad_pixel_ratio=0.04583`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 1,266 JBR command frames, `avg_delta=2.050`,
  `bad_pixel_ratio=0.04821`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 8.3M and disk free was about 197Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-110922/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer offcenter-pivot lifecycle screenshot-parity pair with explicit zero
  ...
  Both exact rows passed with zero picture frames, zero effect-handle markers, zero shader-handle markers, and
  screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 1,302 JBR command frames, `avg_delta=1.910`, `bad_pixel_ratio=0.04592`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 1,240 JBR command frames, `avg_delta=2.050`,
  `bad_pixel_ratio=0.04826`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 8.3M and disk free was about 197Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-110535/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer near-camera lifecycle screenshot-parity pair with explicit zero
  ceilings for JBR effect-handle and shader-handle defines, then reran
  ...
  Both exact rows passed with zero picture frames, zero effect-handle markers, zero shader-handle markers, and
  screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 1,307 JBR command frames, `avg_delta=1.913`, `bad_pixel_ratio=0.04603`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 1,233 JBR command frames, `avg_delta=2.050`,
  `bad_pixel_ratio=0.04826`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 8.2M and disk free was about 197Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-110157/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer scale-translate lifecycle screenshot-parity pair with explicit zero
  ceilings for JBR effect-handle and shader-handle defines, then reran
  ...
  Both exact rows passed with zero picture frames, zero effect-handle markers, zero shader-handle markers, and
  screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 1,244 JBR command frames, `avg_delta=1.906`, `bad_pixel_ratio=0.04576`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 1,443 JBR command frames, `avg_delta=2.049`,
  `bad_pixel_ratio=0.04818`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 8.3M and disk free was about 197Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-105840/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer rotation-XY lifecycle screenshot-parity pair with explicit zero
  ceilings for JBR effect-handle and shader-handle defines, then reran
  ...
  Both exact rows passed with zero picture frames, zero effect-handle markers, zero shader-handle markers, and
  screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 1,203 JBR command frames, `avg_delta=1.911`, `bad_pixel_ratio=0.04596`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 1,227 JBR command frames, `avg_delta=2.050`,
  `bad_pixel_ratio=0.04826`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 8.2M and disk free was about 170Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-105349/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer rotation-Y lifecycle screenshot-parity pair with explicit zero
  ceilings for JBR effect-handle and shader-handle defines, then reran
  ...
  Both exact rows passed with zero picture frames, zero effect-handle markers, zero shader-handle markers, and
  screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 1,275 JBR command frames, `avg_delta=1.908`, `bad_pixel_ratio=0.04582`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 1,274 JBR command frames, `avg_delta=2.048`,
  `bad_pixel_ratio=0.04815`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 8.3M and disk free was about 170Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-105003/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer rotation-X lifecycle screenshot-parity pair with explicit zero
  ceilings for JBR effect-handle and shader-handle defines, then reran
  ...
  Both exact rows passed with zero picture frames, zero effect-handle markers, zero shader-handle markers, and
  screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 633 JBR command frames, `avg_delta=1.909`, `bad_pixel_ratio=0.04586`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 763 JBR command frames, `avg_delta=2.050`,
  `bad_pixel_ratio=0.04825`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 7.4M and disk free was about 170Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-104625/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer path-shadow lifecycle screenshot-parity pair with explicit zero
  ceilings for JBR effect-handle and shader-handle defines, then reran
  ...
  Both exact rows passed with zero picture frames, zero effect-handle markers, zero shader-handle markers, one shadow
  command per frame, and screenshot status passed. The resize row recorded the known single early
  `command-stream-invalid` resize parity artifact, then passed with 1,185 JBR command frames, `avg_delta=1.912`,
  `bad_pixel_ratio=0.04596`, one same-context surface-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. The forced-context row passed fallback-free with 1,007 JBR
  command frames, `avg_delta=2.053`, `bad_pixel_ratio=0.04839`, one destination context-change marker, one
  command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine image refs. This was an exact
  two-row screenshot-parity refresh, not the full suite; output directory was 8.1M and disk free was about 170Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-104227/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer round-shadow lifecycle screenshot-parity pair with explicit zero
  ceilings for JBR effect-handle and shader-handle defines, then reran
  ...
  Both exact rows passed with zero picture frames, zero effect-handle markers, zero shader-handle markers, one shadow
  command per frame, and screenshot status passed. The resize row recorded the known single early
  `command-stream-invalid` resize parity artifact, then passed with 607 JBR command frames, `avg_delta=1.912`,
  `bad_pixel_ratio=0.04592`, one same-context surface-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. The forced-context row passed fallback-free with 618 JBR
  command frames, `avg_delta=2.064`, `bad_pixel_ratio=0.04829`, one destination context-change marker, one
  command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine image refs. This was an exact
  two-row screenshot-parity refresh, not the full suite; output directory was 7.3M and disk free was about 170Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-103906/suite.tsv`.
- Magic Jewel tightened the exact graphics-layer path-clip lifecycle screenshot-parity pair with explicit zero ceilings
  ...
  Both exact rows passed with zero picture frames, zero effect-handle markers, zero shader-handle markers, and
  screenshot status passed. The resize row recorded the known single early `command-stream-invalid` resize parity
  artifact, then passed with 1,309 JBR command frames, `avg_delta=1.912`, `bad_pixel_ratio=0.04597`, one same-context
  surface-change marker, one command-cache clear, one JBR image-cache clear, one scoped image-cache clear, and nine
  image refs. The forced-context row passed fallback-free with 1,252 JBR command frames, `avg_delta=2.053`,
  `bad_pixel_ratio=0.04839`, one destination context-change marker, one command-cache clear, one JBR image-cache
  clear, one scoped image-cache clear, and nine image refs. This was an exact two-row screenshot-parity refresh, not
  the full suite; output directory was 8.4M and disk free was about 170Gi:
  `/Users/rock3r/src/jbr-skia-zero-copy/magic-jewel/out/jbr-skia-screenshot-parity-suite/20260618-103524/suite.tsv`.
