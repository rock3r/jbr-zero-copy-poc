...
- [ ] Generic shader strategy:
  ...
  - [ ] Extend Skia runtime effects via descriptor payloads: source bytes, named uniform block layout, child color-filter handles, richer compile diagnostics, and stable fallback markers.
